...
urlpatterns = [
    ...
    path("dish-types/<int:pk>/update/", DishTypeUpdateView.as_view(), name="dish-type-update"), # noqa
    path("dish-types/<int:pk>/delete/", DishTypeDeleteView.as_view(), name="dish-type-delete"), # noqa
